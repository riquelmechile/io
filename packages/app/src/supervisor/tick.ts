import { tailCursor } from '@io/business-domain/src/index.js';
 ...
 * 6. persist the checkpoint LAST — never before the callback returns.
 *
 ...
 * event). Cursor writes belong ONLY to the supervisor.
 */
